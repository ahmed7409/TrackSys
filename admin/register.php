...
<head>
    ...
    <title>Admin Registration - TrackSys</title>
    ...
    <style>
        ...
        .register-container { background: #fff; padding: 40px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); text-align: center; width: 100%; max-width: 400px; }
        .register-container h2 { margin-bottom: 20px; color: #5a5c69; }
        ...
        .btn { width: 100%; padding: 12px; font-size: 1rem; font-weight: 500; border: none; border-radius: 5px; cursor: pointer; background-color: #1cc88a; color: #fff; transition: background-color 0.3s; }
        .btn:hover { background-color: #17a673; }
...
<body>
    <div class="register-container">
        ...
        <form action="register_logic.php" method="post">
            ...
            <div class="form-group">
                <label for="secret_key">Secret Registration Key</label>
                <input type="text" class="form-control" id="secret_key" name="secret_key" required>
            </div>
            <button type="submit" class="btn">Register</button>
        </form>
        <p style="margin-top: 20px;"><a href="login.php">Already have an account? Login</a></p>
    </div>
</body>
</html>